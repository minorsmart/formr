...
5. This json file can be used as input for a JavaScript object, for instance a [chart](http://www.smartedu.nl/opencpu/test.html). See source code:
<br><br>
<head>
    <style>
        .bar {
...
<body>
    ...
    <script>
        ...
        $(function() {
            ...
            //The following makes a posts the url to the opencpu server on AWS and
